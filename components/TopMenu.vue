  ...
  <div class="relative bg-white">
    <div class="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
          ...
          <div class="absolute z-50 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-xs sm:px-0" v-if="showMoreMenu">
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                ...
                <a href="https://saasstartupguide.substack.com/" target="_blank" class="-m-3 p-3 block rounded-md hover:bg-gray-50">
                  <p class="text-base font-medium text-gray-900">{{ $t('menu.more.startup_guide.title') }}</p>
                  <p class="mt-1 text-sm text-gray-500">{{ $t('menu.more.startup_guide.description') }}</p>
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
        ...
        <a href="https://cloud.billabear.com/login" target="_blank" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> {{ $t('menu.login') }} </a>
      </div>
    </div>
      ...
      <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
        <div class="pt-5 pb-6 px-5">
          <div class="flex items-center justify-between">
            ...
            <div class="-mr-2">
              <button type="button" @click="showResponseMenu = !showResponseMenu" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <div class="mt-6">
            <nav class="grid grid-cols-1 gap-7">
              <NuxtLink to="/branding" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                ...
                <div class="ml-4 text-base font-medium text-gray-900">{{ $t('menu.features.branding.title') }}</div>
              </NuxtLink>
              ...
              <NuxtLink to="/tax" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                ...
                <div class="ml-4 text-base font-medium text-gray-900">{{ $t('menu.features.tax.title') }}</div>
              </NuxtLink>
              ...
              <NuxtLink to="/workflows" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                ...
                <div class="ml-4 text-base font-medium text-gray-900">{{ $t('menu.features.workflows.title') }}</div>
              </NuxtLink>
              ...
              <NuxtLink to="/integrations" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                ...
                <div class="ml-4 text-base font-medium text-gray-900">{{ $t('menu.features.integrations.title') }}</div>
              </NuxtLink>
              ...
              <NuxtLink to="/subscriptions" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                ...
                <div class="ml-4 text-base font-medium text-gray-900">{{ $t('menu.features.subscription_management.title') }}</div>
              </NuxtLink>
              ...
              <NuxtLink to="/reports" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                ...
                <div class="ml-4 text-base font-medium text-gray-900">{{ $t('menu.features.reports.title') }}</div>
              </NuxtLink>
            </nav>
          </div>
        </div>
        <div class="py-6 px-5">
          <div class="grid grid-cols-2 gap-4">
            ...
            <a href="https://saasstartupguide.substack.com/" target="_blank" class="text-base font-medium text-gray-900 hover:text-gray-700"> {{ $t('menu.more.startup_guide.title') }} </a>
          </div>
          <div class="mt-6">
            <a href="https://cloud.billabear.com/signup" target="_blank"  class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> {{ $t('menu.signup') }} </a>
            <p class="mt-6 text-center text-base font-medium text-gray-500">
              {{ $t('menu.exist_customer') }}
              <a href="https://cloud.billabear.com/login" target="_blank" class="text-indigo-600 hover:text-indigo-500"> {{ $t('menu.signup') }} </a>
            </p>
          </div>
        </div>
      </div>
