---
title: "How to compute the tax price for Belgium with VAT Sense"
slug: "how-to-compute-the-tax-price-for-belgium-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, compute tax, tax price, Belgium
  description: How to compute the tax price for Belgium with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to compute a tax price for Belgium"
---
...
Here we'll show you how to compute the tax price for Belgium via the VAT Sense API. This will return the tax rate for Belgium as well as the total amount of the price if the price is exclusive of tax and how much of the price is tax if it's inclusive of tax all depending on the tax rate for Belgium.
