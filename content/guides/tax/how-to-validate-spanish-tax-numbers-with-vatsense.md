...
meta:
  ...
  description: How to validate Spainish VAT Numbers
...
One of the important things to note is that the VAT number **MUST** be prefixed with the 2-letter country code. So for Spain that would be with a GB prefix. 
