---
title: "How to derive the tax price for Sweden with VAT Sense"
slug: "how-to-derive-the-tax-price-for-sweden-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, derive tax, tax price, Sweden
  description: How to derive the tax price for Sweden with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to derive a tax price for Sweden"
---
...
Here we'll show you how to derive the tax price for Sweden via the VAT Sense API. This will return the tax rate for Sweden as well as the total amount of the price if the price is exclusive of tax and how much of the price is tax if it's inclusive of tax all depending on the tax rate for Sweden.
