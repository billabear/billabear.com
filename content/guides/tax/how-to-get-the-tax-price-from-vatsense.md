---
title: "How to get the tax price with VAT Sense"
slug: "how-to-get-the-tax-price-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear
  description: How to get the tax price with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to fetch a tax price"
---
...
For example, if you are selling an ebook it may be a different rate than if you're selling a subscription to a SaaS. And if you sell an ebook to a German it'll be a different rate than if you sold it to a Brit.
