---
title: "How to determine the tax price for Croatia with VAT Sense"
slug: "how-to-determine-the-tax-price-for-croatia-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, determine tax, tax price, Croatia
  description: How to determine the tax price for Croatia with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to determine a tax price for Croatia"
seo: true
---
...
Here we'll show you how to determine the tax price for Croatia via the VAT Sense API. This will return the tax rate for Croatia as well as the total amount of the price if the price is exclusive of tax and how much of the price is tax if it's inclusive of tax all depending on the tax rate for Croatia.
