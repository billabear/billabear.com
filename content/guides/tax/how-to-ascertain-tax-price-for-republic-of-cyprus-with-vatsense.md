---
title: "How to ascertain the tax price for Republic of Cyprus with VAT Sense"
slug: "how-to-ascertain-the-tax-price-for-republic-of-cyprus-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, ascertain tax, tax price, Republic of Cyprus
  description: How to ascertain the tax price for Republic of Cyprus with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to ascertain a tax price for Republic of Cyprus"
seo: true
---
...
Here we'll show you how to ascertain the tax price for Republic of Cyprus via the VAT Sense API. This will return the tax rate for Republic of Cyprus as well as the total amount of the price if the price is exclusive of tax and how much of the price is tax if it's inclusive of tax all depending on the tax rate for Republic of Cyprus.
...
For example, if you are selling an ebook it may be a different rate than if you're selling a subscription to a SaaS. And if you sell an ebook to someone residing in Republic of Cyprus it'll probably be a different rate than if you sold it to someone in a different country.
