---
title: "How to determine the tax price for Germany with VAT Sense"
slug: "how-to-determine-the-tax-price-for-germany-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, determine tax, tax price, Germany
  description: How to determine the tax price for Germany with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to determine a tax price for Germany"
---
...
Here we'll show you how to determine the tax price for Germany via the VAT Sense API. This will return the tax rate for Germany as well as the total amount of the price if the price is exclusive of tax and how much of the price is tax if it's inclusive of tax all depending on the tax rate for Germany.
...
For example, if you are selling an ebook it may be a different rate than if you're selling a subscription to a SaaS. And if you sell an ebook to someone residing in Germany it'll probably be a different rate than if you sold it to someone in a different country.
