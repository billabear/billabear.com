---
title: "How to assess the tax price for Germany with VAT Sense"
slug: "how-to-assess-the-tax-price-for-germany-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, assess tax, tax price, Germany
  description: How to assess the tax price for Germany with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to assess a tax price for Germany"
seo: true
---
...
Here we'll show you how to assess the tax price for Germany via the VAT Sense API. This will return the tax rate for Germany as well as the total amount of the price if the price is exclusive of tax and how much of the price is tax if it's inclusive of tax all depending on the tax rate for Germany.
