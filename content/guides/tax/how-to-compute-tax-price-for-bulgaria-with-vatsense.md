---
title: "How to compute the tax price for Bulgaria with VAT Sense"
slug: "how-to-compute-the-tax-price-for-bulgaria-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, compute tax, tax price, Bulgaria
  description: How to compute the tax price for Bulgaria with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to compute a tax price for Bulgaria"
seo: true
---
