---
title: "How to ascertain the tax price for Hungary with VAT Sense"
slug: "how-to-ascertain-the-tax-price-for-hungary-with-vatsense"
section: tax
author:
  display_name: Iain
meta:
  keywords: subscription management software, SaaS Business, Software as a Service, BillaBear, ascertain tax, tax price, Hungary
  description: How to ascertain the tax price for Hungary with VAT Sense
  title: "A walkthrough of how to use the VAT Sense API to ascertain a tax price for Hungary"
seo: true
---
...
Here we'll show you how to ascertain the tax price for Hungary via the VAT Sense API. This will return the tax rate for Hungary as well as the total amount of the price if the price is exclusive of tax and how much of the price is tax if it's inclusive of tax all depending on the tax rate for Hungary.
...
For example, if you are selling an ebook it may be a different rate than if you're selling a subscription to a SaaS. And if you sell an ebook to someone residing in Hungary it'll probably be a different rate than if you sold it to someone in a different country.
