          ...
          <div class="max-w-md mx-auto space-y-4 lg:max-w-5xl lg:grid lg:grid-cols-3 lg:gap-5 lg:space-y-0">
              ...
              <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                <div>
                  <h3 class="inline-flex px-4 py-1 rounded-full text-sm font-semibold tracking-wide uppercase bg-indigo-100 text-indigo-600"
                      id="tier-standard">{{ $t('pricing.free.title') }}</h3>
                </div>
              ...
              <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                <ul role="list" class="space-y-1">
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.subscription_management') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.custom_plans') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.multi_brands') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.email_support') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.multi_currency') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.template_management') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.multi_language_support') }}</p>
                  </li>
                  <li class="flex items-start">
                    <div class="flex-shrink-0">
                      <!-- Heroicon name: outline/check -->
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.tax_management') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{
                        $t('pricing.features.mass_subscription_management')
                      }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.hosted_checkouts') }}</p>
                  </li>
                  <li class="flex items-start">
                    <div class="flex-shrink-0">
                      <!-- Heroicon name: outline/check -->
            ...
            <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                <div>
                  <h3 class="inline-flex px-4 py-1 rounded-full text-sm font-semibold tracking-wide uppercase bg-indigo-100 text-indigo-600"
                      id="tier-standard">{{ $t('pricing.professional.title') }}</h3>
                </div>
                <div class="mt-4 flex items-baseline text-6xl font-extrabold">
                  {{ $t('pricing.professional.cost') }}
                  <span class="ml-1 text-2xl font-medium text-gray-500">{{
                      $t('pricing.professional.cost_extra')
                    }}</span>
                </div>
            ...
            <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                <div>
                  <h3 class="inline-flex px-4 py-1 rounded-full text-sm font-semibold tracking-wide uppercase bg-indigo-100 text-indigo-600"
                      id="tier-standard">{{ $t('pricing.enterprise.title') }}</h3>
                  <div class="mt-4 flex items-baseline text-6xl font-extrabold">
                    {{ $t('pricing.enterprise.cost') }}
                  </div>
                </div>
              ...
              <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                <ul role="list" class="space-y-1">
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.contact_person') }}</p>
                  </li>
                  ...
                  <li class="flex items-start">
                    ...
                    <p class="ml-3 text-base text-gray-700">{{ $t('pricing.features.custom_envs') }}</p>
                  </li>
